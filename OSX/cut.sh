...
#watch to have the same time for the audio & video file to synchronize
	...
	ffmpeg -i /Users/alexandreracine/Desktop/test/audio.aac -ss 00:00:01 -t 00:00:06 -c:a copy /Users/alexandreracine/Desktop/test/audio_cut.aac
...
#adapt the 2 time values according to your needs.
	...
	for name in /Users/alexandreracine/Desktop/test/*.mp4; do
...
#Do the same for ".mov" files and add "-c:v" + video codec libxvid + qscale parameter" to be sure to keep the codec for safari with the .mov container
	...
	for name in /Users/alexandreracine/Desktop/test/*.mov; do
...
#different browsers with the .webm container.
	...
	for name in /Users/alexandreracine/Desktop/test/*.webm; do
...
#Compile the cut audio & video files. Watch to have the audio & video files synchronized with the same duration
	...
	for file in /Users/alexandreracine/Desktop/test/*_cut.mp4; do
          ffmpeg -i "$file" -i /Users/alexandreracine/Desktop/test/audio_cut.aac -strict experimental "${file%.mp4}"_all.mp4;
        done
        for file in /Users/alexandreracine/Desktop/test/*_cut.mov; do
          ffmpeg -i "$file" -i /Users/alexandreracine/Desktop/test/audio_cut.aac -c:v libxvid -c:a aac -qscale:v 3 -strict experimental "${file%.mov}"_all.mov;
        done
        for file in /Users/alexandreracine/Desktop/test/*_cut.webm; do
          ffmpeg -i "$file" -i /Users/alexandreracine/Desktop/test/audio_cut.aac -c:v libvpx -crf 18 -b:v 0 -c:a libvorbis -strict experimental "${file%.webm}"_all.webm;
        done
