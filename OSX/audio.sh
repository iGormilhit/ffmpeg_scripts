...
#device to record acording to your system. Then put the number "0, 1 or n". Consult ffmpeg documentation to know more options or to grab audio on other systems.
